...
const WithdrawalRequest = () => {
  ...
  const { data, isLoading, isFetching } = useGetWithdrewQuery({
    entityType: selectedView,
    searchTerm,
    page,
  });
        ...
        <div className="space-y-4">
          <p>
            ...
            <span className="float-right">
              {selectedRecord?.entityId?.name}
            </span>
          </p>
          <p>
            Request Amount:{' '}
            <span className="float-right">{selectedRecord?.amount}</span>
          </p>
          ...
          {selectedRecord?.accountType && (
            <p>
              Account Type:{' '}
              <span className="float-right">{selectedRecord?.accountType}</span>
            </p>
          )}
          {selectedRecord?.bankName && (
            <p>
              Bank Name:{' '}
              <span className="float-right">{selectedRecord?.bankName}</span>
            </p>
          )}
