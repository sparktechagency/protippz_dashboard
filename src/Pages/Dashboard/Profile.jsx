    ...
    <div className="bg-[var(--bg-gray-20)] p-4 rounded-md">
      ...
      <div className="center-center flex-col gap-6 mt-6 pb-4">
        ...
        <div className="center-center gap-3">
          <button
            onClick={() => set_tab('edit_profile')}
            className={`${
              tab === 'edit_profile' ? 'button-black' : 'button-white'
            }`}
          >
            Update Profile
          </button>
          <button
            onClick={() => set_tab('change_password')}
            className={`${
              tab === 'change_password' ? 'button-black' : 'button-white'
            }`}
          >
            Change Password
          </button>
        ...
        {tab === 'edit_profile' ? (
          <UpdateProfileForm image={image} data={data?.data} />
        ) : (
          <UpdatePassword />
        )}
      </div>
