    ...
    const data = [
        {
            title: 'Teams',
            count: 10,
            icon: <img src={teamIcon} alt="Team" className="h-20 object-cover w-20" />,
        },
        {
            title: 'Players',
            count: 10,
            icon: <img src={playerIcon} alt="Player" className="h-20 object-cover w-20" />,
        },
        {
            title: 'Tips',
            count: 10,
        ...
        },
        {
            title: 'Top Fans',
            count: 10,
            icon: <img src={topFanIcon} alt="Top Fan" className="h-20 object-cover w-20" />,
        },
    ]
    return (
        <PageLayout>
            <PageContent>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {data.map((item) => (
                        <StatusCard key={item.title} title={item.title} count={item.count} icon={item.icon} />
                    ))}
                </div>
